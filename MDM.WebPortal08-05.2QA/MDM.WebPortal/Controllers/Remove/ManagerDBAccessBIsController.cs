    ...
    public class ManagerDBAccessBIsController : Controller
    {
        ...
        public ActionResult Products_Read([DataSourceRequest]DataSourceRequest request)
        {
            using (var vardb = new MedProDBEntities())
            {
                ...
                return
                    Json(
                        vardb.ManagerDBAccessBIs.ToDataSourceResult(request,
                            x => new MDM.WebPortal.Models.ViewModel.ManagerDBAccessBIViewModel
                            {
                                id = x.id,
                                active = x.active,
        ...
        public ActionResult Products_Update([DataSourceRequest]DataSourceRequest request, MDM.WebPortal.Models.ViewModel.ManagerDBAccessBIViewModel product)
        {
            if (ModelState.IsValid)
            {
