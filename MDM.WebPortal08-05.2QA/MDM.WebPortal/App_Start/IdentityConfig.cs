...
namespace IdentitySample.Models
{
    ...
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            // Credentials:
            //var sendGridUserName = "emedservice";
            //var sentFrom = "emedservicecorp@gmail.com";
            //var sendGridPassword = "/*Emma123";
    ...
    public class ApplicationDbInitializer : DropCreateDatabaseIfModelChanges<ApplicationDbContext> 
    {
        ...
        public static void InitializeIdentityForEF(ApplicationDbContext db) {
            ...
            const int rolePriority = 1; //Most important.
            const bool roleActive = true;

            //Create Role Admin if it does not exist
            var role = roleManager.FindByName(roleName);
            if (role == null) {
                role = new ApplicationRole(roleName, roleActive, rolePriority);
