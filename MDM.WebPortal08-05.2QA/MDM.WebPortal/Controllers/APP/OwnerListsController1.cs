...
//{
//    public class OwnerListsController1 : Controller
//    {
...
//        {
//            //var filter = new FilterDescriptor { Member = "LastName", Operator = FilterOperator.Contains, Value = "sua" };
//            //request.Filters = new List<IFilterDescriptor>{filter};
//            return Json(db.OwnerLists.ToDataSourceResult(request, x => new VMOwnerList1
//            {
//                OwnersID = x.OwnersID, 
//                active = x.active, 
...
//        public ActionResult GetAllOwners([DataSourceRequest] DataSourceRequest request)
//        {
//            var result = db.OwnerLists.OrderBy(x => x.LastName).Select(x => new VMOwner
//            {
//                OwnersID = x.OwnersID,
...
//        public async Task<ActionResult> Update([DataSourceRequest] DataSourceRequest request, [Bind(Include = "OwnersID,LastName,FirstName,active")] VMOwnerList1 ownerList)
//        {
...
//            [Bind(Include = "OwnersID,LastName,FirstName,active")] VMOwnerList1 ownerList)
//        {
//            if (ModelState.IsValid)
//            {
//                try
